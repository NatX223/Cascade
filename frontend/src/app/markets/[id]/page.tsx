    ...
    >
      ...
      >
        ...
        <button
          ...
          style={{ fontFamily: "'General Sans', sans-serif", fontSize: 15, fontWeight: 500, color: "#0A0A16", background: "#7C5CFF", border: "none", padding: "11px 20px", borderRadius: 14, cursor: "pointer" }}
        >
          Connect wallet
        </button>
      </header>
